...
def correlation_plots(fish1_speed, fish2_speed, fish1_angles, fish2_angles,
    ...
    if corr == 1:
        ...
        plt.figure()
        plt.title(f"{dataset_name}: Speed Cross-Correlation Plot Between Two Fish")
        plt.xlabel("Lag; WS = {window_size}")
    ...
    if auto == 1:
        ...
        plt.figure()
        plt.title(f"{dataset_name}: Speed Autocorrelation Plot Between Two Fish [Fish1]")
        ...
        plt.figure()
        plt.title(f"{dataset_name}: Speed Autocorrelation Plot Between Two Fish [Fish2]")
        plt.ylim(cross_corr_min, cross_corr_max)
        plt.xlabel("Lag; WS = {window_size}")
        plt.ylabel("Correlation Coefficients")
    ...
    if shuff == 1:
        ...
        plt.figure()
        plt.title(f"{dataset_name}: Shuffled Speed Cross-Correlation Plot Between Two Fish")
        plt.xlabel("Lag; WS = {window_size}")
        plt.ylabel("Correlation Coefficients")
